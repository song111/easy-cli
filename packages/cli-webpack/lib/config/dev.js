        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            api.chainWebpack(function (webpackConfig) {
              ...
              webpackConfig.watch(true).mode('development').devtool('cheap-module-eval-source-map').output.filename('static/js/[name].js');
              /**
               * devServer
               */

              webpackConfig.devServer // 热更新ws地址与location.host保持一致
              ...
              webpackConfig.plugin('hmr').use(_webpack.HotModuleReplacementPlugin);
              /***
               * 错误提示
               */

              webpackConfig.plugin('friendly-errors').use(_friendlyErrorsWebpackPlugin["default"], [{
